...
for z in range (1,14):
    ...
    for j in range (1,14):
        ...
        for i in range(0,nb_prediction):
            ...
            model_path = f'/home/s2316001/codepaper/model_log/logistic_regression_file{z}_model{i}.sav'  # Change the path to the saved model
            ...
            plt.savefig(f'/home/s2316001/codepaper/model_log_test_file{z}/logreg_confusion_matrix_file{j}_No{i}.png')
