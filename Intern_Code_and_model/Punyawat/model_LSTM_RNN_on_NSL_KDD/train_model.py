...
if gpus:
    try:
        ...
        if len(gpus) > 0 and len(logical_gpus) > 0:
...
model_path = '/home/s2316002/Project1/DL_4/'
graph_path = '/home/s2316002/Project1/DL_4/graph/'
...
for (neurons, layers), dropout_rate in zip(model_shapes, dropout_rates):
    ...
    for i in range(layers):
        if i < layers - 1: # For all layers except the last one
