...
#     filename = f'/home/s2316001/codepaper/model/GB{i}.sav'
...
#     # set plot title
#     ax.set_title(f"Confusion Matrix for the Anomaly Gradient Detection Model {i}", fontsize=14, pad=20)
#     plt.savefig(f'/home/s2316001/codepaper/graph/GBconfusion_matrix{i}.png')
...
for j in range (3,14):
    ...
    for i in range(0, nb_prediction):
        ...
        tab_test_recall[i] = recall[1]
        tab_test_fbeta_score[i] = fbeta_score[1]
        filename = f'/home/s2316001/codepaper/model_GB/gradient_boosting_file{j}_model{i}.sav'
        joblib.dump(clf, filename)
    print("Train")
    print("precision = ", tab_train_precision.mean(), tab_train_precision.std(), tab_train_precision)
    print("recall = ", tab_train_recall.mean(), tab_train_recall.std(), tab_train_recall)
