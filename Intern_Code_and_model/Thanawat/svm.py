...
plt.savefig("/home/s2316001/cross_validation_svm_gamma.pdf", format="pdf")
plt.show()
...
plt.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig("/home/s2316001/cross_validation_svm_degree.pdf", format="pdf")
plt.show()
...
plt.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig("/home/s2316001/cross_validation_svm_penalty.pdf", format="pdf")
plt.show()
...
filename = f'/home/s2316001/codepaper/model/svm.sav'
