...
for j in range (9,14):
    ...
    for i in range(0, nb_prediction):
        ...
        clf = linear_model.LogisticRegression(penalty='l2', C=150, random_state=tab_seed[i], multi_class="auto", class_weight={0:0.2, 1:1-0.2}, solver="lbfgs", max_iter=1000, verbose=0)
        ...
        filename = f'/home/s2316001/codepaper/model_log/logistic_regression_file{j}_model{i}.sav'
