...
#data['Label'] = np.where(data['Label'].str.slice(0, 15) == 'flow=From-Botnet', 1, 0)
#labels = np.array(['no-attack', 'attack'])
...
X.drop('SrcAddr', axis=1).to_hdf('/home/s2316001/codepaper/data_window.h5', key="data", mode="w")
np.save("/home/s2316001/codepaper/data_window_id.npy", X['SrcAddr'])
np.save("/home/s2316001/codepaper/data_window_labels.npy", labels)